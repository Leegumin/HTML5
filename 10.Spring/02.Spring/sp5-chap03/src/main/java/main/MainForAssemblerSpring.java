 ...
 */
public class MainForAssemblerSpring {
    // 객체를 생성 : Member 객체, 패스워드변경 서비스 객체, 회원등록 객체 생성
    // spring 사용 시 spring에서 다 작업을 해주기 때문에 필요가 없어짐
...
//        MemberRegisterService reqSvc = assembler.getMemberRegisterService();
        ...
        // 스프링에 객체를 요청 : MemberRegisterService
//        MemberRegisterService reqSvc =
//                ctx.getBean("memberRegSvc", MemberRegisterService.class);

// @ComponentScan으로 이름 또한 자동으로 등록된 상태라 이름을 빼줘야함
        MemberRegisterService reqSvc =
